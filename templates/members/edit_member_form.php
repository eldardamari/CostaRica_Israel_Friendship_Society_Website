<form enctype="multipart/form-data" id="edit_member_form" class="general_form" method="post" action="<?php echo $_SERVER["PHP_SELF"]?>">

    <fieldset>
        <legend>Personal data:</legend>


        <label for="select_memeber">Select Member</label>
        <select class="form_field" id="select_memeber" name="select_memeber" required autofocus="">
            <option value="Select Member.." disabled selected value="">Select Member..</option>
            <?php 
                $members = get_members_names();
        ...
        <button name="deleteMember" id="deleteMember" hidden="" type="submit" class="btn_default">
    ...
    <input type="hidden" name="edit_member_request" value="true">
